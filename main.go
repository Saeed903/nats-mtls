...
func main() {
	...
	flag.StringVar(&clientCertFile, "tls.cert.client", "client-cert.pem", "TLS client cert file.")
	flag.StringVar(&clientKeyFile, "tls.key.client", "client-key.pem", "TLS client key file.")
